...
Although my analysis does not identify the casual relationship since many other factors, such as local government’s policies, may also change people’s health literacy and awareness, I illustrate how racial composition and political climates may contribute to people’s interests in COVID-19-related behavior. As a student of computational social science, combining dgital trace and survey data provides us unprecedented opportunities to observe people’s behavior in large scale and show the importance of racial and political contexts in the U.S. during the pandemic.
