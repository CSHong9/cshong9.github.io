...
In sum, my analysis illustrates that racial composition and political climates may contribute to people’s interests in COVID-19-related behavior, which may then shape the outcomes of the pandemic. Although the results are not casual relationships, it is important to ask why we observe such strong correlations among these factors. As a student of computational social science, combining digital trace and survey data also provides us unprecedented opportunities to observe people’s behavior in large scale and engage in important debates over race, politics, and health.
